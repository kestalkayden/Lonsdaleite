...
public class Perfect_Lonsdaleite_War_Axe extends SwordItem {
    public Perfect_Lonsdaleite_War_Axe(ToolMaterial material, int attackDamage, float attackSpeed, Item.Properties properties) {
