...
public class Perfect_Lonsdaleite_Short_Sword extends SwordItem {
    public Perfect_Lonsdaleite_Short_Sword(ToolMaterial material, int attackDamage, float attackSpeed, Item.Properties properties) {
