...
public class Perfect_Lonsdaleite_Axe extends AxeItem {

    public Perfect_Lonsdaleite_Axe(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
