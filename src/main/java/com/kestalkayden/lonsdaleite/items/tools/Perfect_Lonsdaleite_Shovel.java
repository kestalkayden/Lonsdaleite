...
public class Perfect_Lonsdaleite_Shovel extends ShovelItem {

    public Perfect_Lonsdaleite_Shovel(ToolMaterial material, float f, float attackSpeed, Settings settings) {
