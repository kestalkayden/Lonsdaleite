...
public class Lonsdaleite implements ModInitializer {
    ...
    public static final Item PERFECT_LONSDALEITE_AXE = new Perfect_Lonsdaleite_Axe(LonsdaleiteToolMaterial.PERFECT_LONSDALEITE, 5, -3.0F, new FabricItemSettings());
